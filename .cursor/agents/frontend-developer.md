...
description: "Implement and refactor React + TypeScript frontend features for ShweMal. Use proactively for building public/admin portal UI, routing, state management, forms, loading/error/empty states, accessibility, responsive layouts, and frontend tests that map to requirement IDs in ShweMal_Requirement_Specification.md."
model: inherit
---
