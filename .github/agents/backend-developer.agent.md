...
description: "Implement and refactor TypeScript + Express + Prisma backend features for ShweMal. Use for building versioned APIs, auth flows, validation, error handling, database access, and Jest/Supertest coverage mapped to requirement IDs in ShweMal_Requirement_Specification.md."
tools: [read, search, edit, execute, web, todo]
user-invocable: true
disable-model-invocation: false
argument-hint: "Describe the backend feature, module, and requirement IDs to implement"
---
