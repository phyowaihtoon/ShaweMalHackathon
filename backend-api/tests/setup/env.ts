...
process.env.DATABASE_TARGET = process.env.DATABASE_TARGET ?? 'local';
process.env.DATABASE_URL = process.env.DATABASE_URL ?? 'postgresql://test:test@localhost:5432/shawemal_test';
